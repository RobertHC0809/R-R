...
class PayPalController extends Controller
{
    ...
    public function createTransaction($id_factura)
    {
        ...
        //  $precio = 120.99;
          $precioreserva = factura::select('MontoTotal')->where('id_factura', $id_factura)->first()->MontoTotal;
        ...
        $order = $paypal->createOrder([
            ...
            "application_context" => [
                "return_url" => route('captureTransaction', ['id_factura' => $id_factura]),
    ...
    public function captureTransaction(Request $request, $idreservacion)
    {
        ...
        if ($result['status'] == 'COMPLETED') {
            ...
            return redirect()->route('Reservacion.pagado', ['id_factura' => $id_factura]);
        }
