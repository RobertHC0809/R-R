...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-dark navbar-dark py-1 py-lg-0 px-lg-5">
      ...
      @else
          <a href="{{ route('Formulario') }}" class="nav-item nav-link">Inicia Sesion</a>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    ...
                    <p>Llevar el mejor servicio de ventas. instalaciones, mantenimientos electromecánicos y obras a fines, a cada una de la empresa o personas que soliciten nuestros servicios profesional, realizando un trabajo de calidad y eficiencia, innovando día a día el trabajo, para así garantizar la excelencia de labor a toda la República Dominicana</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container py-5">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Ser la empresa número uno en el mercado profesional del país en ventas y servicios electromecánicos: asumiendo así la responsabilidad y compromiso de la satisfacción de nuestros clientes y personal de trabajo.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="section-title position-relative text-center">
                ...
                <h1 class="display-4">Todos Nuestros productos</h1>
                    <a class="btn btn-primary font-weight-bold py-3 px-5 mt-4 btn-scroll" href="productos.html">Ver productos</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5" id="contact">
        <div class="container py-5">
            <div class="section-title position-relative text-center">
                ...
                <h1 class="font-secondary display-4">Escribenos</h1>
            </div>
                    ...
                    <div class="contact-form">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            <div class="form-row">
                                ...
                                <div class="col-sm-6 control-group">
                                    <input type="email" class="form-control bg-secondary border-0 py-4 px-3" name= "email" id="email" placeholder="Tu Dirección Email" required="required"/>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>     
                            <div class="control-group">
                                <input type="text" class="form-control bg-secondary border-0 py-4 px-3" name= "phone" id="phone" placeholder="Número de teléfono" required="required"/>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <textarea class="form-control bg-secondary border-0 py-2 px-3" rows="6" name= "message" id="comment" placeholder="Mensaje" required="required" ></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-primary font-weight-bold py-3 px-5" type="button" onclick="enviarAndPhone('ryrmensajes@gmail.com')"
                                class="submit">Enviar mensaje</button></div>
                            </div>
                        </form>
                    </div>
                </div>
