...
<body>
    <div class="container">
        ...
        <form id="login-form" class="form" action="{{ route('login') }}" method="POST">
            ...
            <input type="text"  name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Correo electrónico">
            <input type="password"  name="password"  required autocomplete="current-password" placeholder="Contraseña">
            <button type="submit" class="btn">Iniciar sesión</button>
            <a class="switch-text" href="{{ route('password.request') }}">Olvidé mi contraseña</a>
        ...
        <form id="register-form" class="form hidden" action="{{ route('register') }}" method="POST">
            ...
            <input type="password"  name="password_confirmation" required autocomplete="new-password" placeholder="Confirmar contraseña" required>
